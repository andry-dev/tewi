...
namespace tewi
{
     ...
     *
     * Use it if you don't want to mess around resources and just want a basic
     * Sprite class.
     *
     */
    ...
    class TEWI_EXPORT Sprite
    {
      public:
        Sprite(const glm::vec2& pos, const std::string& path)
            : m_renderable(
                  pos,
                  ResourceManager<APIType, TextureCache>::getResource(path),
         ...
         *
         */
        operator const Renderable2D<APIType>()
        {
            return m_renderable;
        }
         ...
         *
         */
        operator const Physics::Collidable2D()
        {
            return m_collidable;
        }
         ...
         *
         * Needed for the collision checking and basically everything that uses
         * collidables.
         */
        auto getCollidable() const
        {
            return m_collidable;
        }
