...
namespace tewi
{
    ...
    {
        static_assert(detail::disable_type<T>::value,
                      "Tried to pass an unsupported value");
    }

    template <>
    /* TEWI_EXPORT */ void setUniform<asl::f32>(asl::i32 uniformID,
                                                asl::f32 uniformVal)
    {
    ...
    template <>
    /* TEWI_EXPORT */ void setUniform<asl::f64>(asl::i32 uniformID,
                                                asl::f64 uniformVal)
    {
    ...
    template <>
    /* TEWI_EXPORT */ void setUniform<asl::u32>(asl::i32 uniformID,
                                                asl::u32 uniformVal)
    {
    ...
    template <>
    /* TEWI_EXPORT */ void setUniform<asl::i32>(asl::i32 uniformID,
                                                asl::i32 uniformVal)
    {
        glUniform1i(uniformID, uniformVal);
    }

    /* TEWI_EXPORT */ void setUniform(asl::i32 uniformID,
